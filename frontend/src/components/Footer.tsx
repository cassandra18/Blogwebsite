            ...
            <div className="px-4 pt-16 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
                <div className="grid lg:grid-cols-6 mb-0">
                    ...
                    <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
                            <p className="font-medium tracking-wide text-white">Subscription</p>
                            <form className="mt-4 flex flex-col md:flex-row">
                                <div className="flex py-2 space-x-2">
                                <label className="text-gray-500 ">Email:</label>
                                <input type="email" name="email" id="email"
                                className="w-full h-8 px-4 rounded  focus:outline-none border "/>
                                <button type="button" className="inline-flex px-6 items-center rounded border text-gray-500 
